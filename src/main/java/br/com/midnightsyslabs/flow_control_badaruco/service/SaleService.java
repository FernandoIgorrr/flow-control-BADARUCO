...
import br.com.midnightsyslabs.flow_control_badaruco.domain.entity.partner.Partner;
import br.com.midnightsyslabs.flow_control_badaruco.domain.entity.product.Product;
import br.com.midnightsyslabs.flow_control_badaruco.domain.entity.sale.Sale;
import br.com.midnightsyslabs.flow_control_badaruco.domain.entity.sale.SaleProduct;
import br.com.midnightsyslabs.flow_control_badaruco.dto.SaleDTO;
import br.com.midnightsyslabs.flow_control_badaruco.exception.SaleNotFoundException;
import br.com.midnightsyslabs.flow_control_badaruco.repository.partner.PartnerRepository;
import br.com.midnightsyslabs.flow_control_badaruco.repository.product.ProductRepository;
import br.com.midnightsyslabs.flow_control_badaruco.repository.sale.SaleRepository;
import br.com.midnightsyslabs.flow_control_badaruco.repository.view.SaleProductViewRepository;
import br.com.midnightsyslabs.flow_control_badaruco.repository.view.SaleViewRepository;
import br.com.midnightsyslabs.flow_control_badaruco.ui.controller.form.ProductRow;
